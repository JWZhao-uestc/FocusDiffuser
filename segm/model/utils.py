...
def inference(
    ...
    with torch.no_grad():
        seg_map, pred_edge, lookup = model.forward(ims, gt)
    return seg_map, pred_edge, lookup
...
# ):
#     with torch.no_grad():
#         #print(im.shape, ep_im.shape, ep_seg_gt.shape)
#         query_seg_pred, ep_seg_pred, query_x, ep_x, query_mask_embed_, ep_mask_embed_, query_mask_embed_vtm = model.forward(im,ep_im,seg_gt,ep_seg_gt,ep_seg_gt_32,half_mask) ###
#     return query_seg_pred, ep_seg_pred, query_x, ep_x, query_mask_embed_, ep_mask_embed_, query_mask_embed_vtm
